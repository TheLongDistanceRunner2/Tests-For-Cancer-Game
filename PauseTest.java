...
public class PauseTest {
    ...
    @Given("I_ have Graphics2D graph")
    ...
    @Then("I set background_ color with {string}")
    ...
    @Then("I set font_ with {string}")
    public void i_set_font_with(String s1) {
        this.font = Game.Fonts.getFont(s1, Font.BOLD, 50);
    ...
    @When("i is equal to now I set color with {string}")
    public void i_is_equal_to_now_i_set_color_with(String string) {
    ...
    @When("i is not equal to now I set color with {string}")
    public void i_is_not_equal_to_now_i_set_color_with(String string) {
        for (int i = 0; i < options.length; i++){
            if(i != now){
    ...
    @Then("I I draw_ string at position {int} {int}")
    public void i_i_draw_string_at_position(Integer int1, Integer int2) {
        for (int i = 0; i < options.length; i++){
